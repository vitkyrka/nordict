...
class FavoritesFragment : CommonListFragment(FavoritesEntry.TABLE_NAME) {
    ...
    override fun getCursor(db: SQLiteDatabase): Cursor {
        val projection = arrayOf(FavoritesEntry._ID, FavoritesEntry.COLUMN_NAME_DICT, FavoritesEntry.COLUMN_NAME_TITLE, FavoritesEntry.COLUMN_NAME_SUMMARY, FavoritesEntry.COLUMN_NAME_URL)
